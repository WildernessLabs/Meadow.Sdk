...
namespace MeadowCLI.DeviceManagement
{
    public static class MeadowFileManager
    {
        ...
        public enum HcomMeadowRequestType : UInt16
        {
			...
			HCOM_MDOW_REQUEST_MONO_PAUSE = 0x0f | HcomProtocolHeaderTypes.HCOM_PROTOCOL_HEADER_TYPE_SIMPLE,
			HCOM_MDOW_REQUEST_MONO_ENDPAUSE = 0x10 | HcomProtocolHeaderTypes.HCOM_PROTOCOL_HEADER_TYPE_SIMPLE,
