...
namespace Meadow
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "Meadow Application", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension)]
